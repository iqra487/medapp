...
class DocAppointmentPage extends StatefulWidget {
  const DocAppointmentPage({super.key});

  @override
  State<DocAppointmentPage> createState() => _DocAppointmentPageState();
}

enum FilterStatus { upcoming, completed, canceled }

class _DocAppointmentPageState extends State<DocAppointmentPage> {
